...
public class VentanaGraficosMantenimientoInternal extends JPanel {
    private DefaultTableModel model;

    public VentanaGraficosMantenimientoInternal(DefaultTableModel model) {
        this.model = model;

        setLayout(new GridLayout(2, 2)); // 4 gráficos en una fila
        setPreferredSize(new Dimension(480, 510)); // Tamaño ajustado para el panel
