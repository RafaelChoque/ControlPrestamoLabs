...
public class VentanaGraficosMultiplesSanciones extends JFrame {
    private DefaultTableModel model;

    public VentanaGraficosMultiplesSanciones(DefaultTableModel model) {
        this.model = model;
        setTitle("Gráficos de Sanciones");
