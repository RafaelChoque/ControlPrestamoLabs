 ...
 */
public class InicioAdmiTecnico extends javax.swing.JFrame {

    /**
     * Creates new form InicioAdmiTecnico
     */
    public InicioAdmiTecnico() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InicioAdmiTecnico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InicioAdmiTecnico().setVisible(true);
            }
        });
    }
