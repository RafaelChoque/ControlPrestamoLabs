...
"Estás asistiendo al administrador dentro de la interfaz de 'Técnico Préstamos'. " +
"Ayúdalo a entender que en esta sección puede gestionar a los usuarios que son técnicos encargados de los préstamos de laboratorios: puede registrar nuevos usuarios, habilitarlos o deshabilitarlos del sistema, modificar sus datos, y también eliminar registros si es necesario. " +
"Además, puede ver una tabla que muestra todos los técnicos registrados con sus respectivos datos. " +
"Cuando se crea un nuevo técnico, se deben ingresar los siguientes datos obligatorios: RU (Registro Único), nombre, apellidos, CI (Carnet de Identidad) y teléfono. " +
...
"Si el administrador pregunta por otros tipos de usuarios como personal académico, técnicos de mantenimiento o usuarios del Vicerrectorado Académico, menciónale que pueden registrarse desde otras interfaces si desea más detalles. " +
...
"Si se confunde o pide aclaración, ayúdalo con paciencia y ejemplos simples. Evita respuestas largas a menos que él las pida."
        ...
        aplicarColorFilasAlternadas(TablaTecnicoPrestamo);
        ID.setVisible(false);
...
private void toggleMiniChat() {
        ...
        try{
            ...
            int idAdmin = SesionUsuario.idUsuario;
                ...
                String detalleLog = "Usuario: '" + usuarioAdmin + "' Rol '" + rolAdmin +
                    "' registró nuevo Tecnico de Prestamos: " + nombre + " " + apellido +
                    ", CI: " + ci + ", RU: " + ru;
    ...
    private void modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarActionPerformed
        ...
        try{
            ...
            String detalleLog = "Usuario: '" + usuarioAdmin + "' Rol: '" + rolAdmin +
                "' modificó los datos del Tecnico de Prestamos con ID de usuario: " + idUsuario;
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                String detalleLog = "Usuario: '" + usuarioAdmin + "' Rol: '" + rolAdmin +
                    "' eliminó al Tecnico de Prestamos con ID de usuario: " + idUsuario;
    ...
    private void HabilitarDeshabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HabilitarDeshabilitarActionPerformed
        ...
        try {
            ...
            String detalleLog = "Usuario: '" + usuarioAdmin + "' Rol: '" + rolAdmin + 
                "' realizó la acción '" + accion + "' sobre el Tecnico de Prestamos con ID de usuario: " + idUsuario;
            LogManager.registrarLog(idAdmin, rolAdmin, accion, detalleLog);
    ...
    private void btnCerrarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCerrarSesionActionPerformed
        ...
        LogManager.registrarLog(idUsuario, rol, "Cerrar Sesión", "Usuario '" + usuario + "' Rol: '" + rol + "' cerró sesión correctamente.");        Login cerrar = new Login();
