...
"Estás asistiendo al administrador dentro de la interfaz de 'Personal Académico'. " +
"Ayúdalo a entender que en esta sección puede gestionar a los usuarios que son personal académico: puede registrar nuevos usuarios, habilitarlos o deshabilitarlos del sistema, modificar sus datos, y también eliminar registros si es necesario. " +
"Además, puede ver una tabla que muestra todos los usuarios creados con sus respectivos datos. " +
"Cuando se crea un nuevo usuario del tipo personal académico, se deben ingresar los siguientes datos obligatorios: RU (Registro Único), nombre, apellidos, CI (Carnet de Identidad), teléfono y email. " +
"Responde de forma precisa, directa y sin rodeos innecesarios. No repitas todo el contexto si el usuario hace una pregunta específica. " +
"Si el administrador pregunta por otros tipos de usuarios como técnicos de equipos, técnicos de préstamos o usuarios del Vicerrectorado Académico, menciónale que pueden registrarse desde otras interfaces si desea más detalles. " +
"También puede acceder a la interfaz de Auditoría para revisar los logs del sistema, pero solo informa sobre esto si pregunta. " +
...
"Si se confunde o pide aclaración, ayúdalo con paciencia y ejemplos simples. Evita respuestas largas a menos que él las pida."
        );
        aplicarColorFilasAlternadas(TablaPersonalAcademico);
...
private void aplicarColorFilasAlternadas(JTable tabla) {
    ...
    private void initComponents() {
        ...
        TablaPersonalAcademico.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "RU", "Nombre", "Apellido", "CI", "Teléfono", "Estado", "Email"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class
            };
        ...
        jPanel1.add(guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, -1, -1));
        ...
        jPanel1.add(modificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 230, -1, -1));
        ...
        jPanel1.add(eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 230, -1, -1));
        ...
        jPanel1.add(limpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 230, -1, -1));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, -1, 20));
        ...
        jPanel1.add(HabilitarDeshabilitar, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, -1, -1));
        ...
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, -1, 20));
        ...
        jPanel1.add(Email, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 200, 430, -1));

        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 100, 550, 270));
    ...
    private void cargarTabla(){
        ...
        int [] anchos= {10, 50, 100 ,100, 80, 90, 50, 150};
        ...
        try {
            ...
            ps = con.prepareStatement(
                    "SELECT p.id_personal_academico, p.RU, p.nombre, p.apellido, p.CI, p.telefono, u.activo, p.email "
            ...
            while (rs.next()) {
                ...
                fila[6] = rs.getInt("activo") == 1 ? "Activo" : "Inactivo";
    ...
    if (ruText.isEmpty() || nombre.isEmpty() || apellido.isEmpty() || ciText.isEmpty() || telefonoText.isEmpty() || email.isEmpty()){
    ...
    try {
        ...
        PreparedStatement psUsuario= con.prepareStatement("INSERT INTO usuarios(username, contrasena, rol, activo) VALUES(?, ?, ?, ?)",Statement.RETURN_GENERATED_KEYS);
                ...
                PreparedStatement psPersonalAcademico=con.prepareStatement("INSERT INTO personal_academico(id_usuario, RU, nombre, apellido, CI, telefono, email)VALUES(?,?,?,?,?,?,?)");
                ...
                psPersonalAcademico.setString(7, email);
                ...
                String detalleLog = "Usuario: '" + usuarioAdmin + "' Rol '" + rolAdmin +
                    "' registró nuevo Personal Académico con nombre: " + nombre + " " + apellido +
                    ", CI: " + ci + ", RU: " + ru;
    ...
    private void modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarActionPerformed
        ...
        try{
            ...
            String detalleLog = "Usuario: '" + usuarioAdmin + "' Rol: '" + rolAdmin +
                "' modificó los datos del Personal Académico con ID de usuario: " + idUsuario;
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        int personalAcademicoId = Integer.parseInt(ID.getText());

        try {
            Connection con = Conexion.obtenerConexion();

            PreparedStatement psVerificar = con.prepareStatement(
                    "SELECT estado, id_usuario FROM personal_academico WHERE id_personal_academico = ?"
            );
            psVerificar.setInt(1, personalAcademicoId);
            ...
            if (rs.next()) {
                ...
                PreparedStatement psActualizarEstado = con.prepareStatement(
                        "UPDATE personal_academico SET estado = 0 WHERE id_personal_academico = ?"
                );
                psActualizarEstado.setInt(1, personalAcademicoId);
                ...
                String detalleLog = "Usuario: '" + usuarioAdmin + "' Rol: '" + rolAdmin +
                    "' eliminó al Personal Académico con ID de usuario: " + idUsuario;

                LogManager.registrarLog(idAdmin, rolAdmin, accion, detalleLog);
                Limpiar();
                cargarTabla();
            } else {
                JOptionPane.showMessageDialog(null, "No se encontró al personal académico");
            }
        } catch (SQLException ex) {
    ...
    private void HabilitarDeshabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HabilitarDeshabilitarActionPerformed
        ...
        if (fila == -1) {
            JOptionPane.showMessageDialog(null, "Por favor, seleccione un Personal.");
            return;
        }
        ...
        try {
            ...
            String detalleLog = "Usuario: '" + usuarioAdmin + "' Rol: '" + rolAdmin + 
                "' realizó la acción '" + accion + "' sobre el Personal Académico con ID de usuario: " + idUsuario;
            LogManager.registrarLog(idAdmin, rolAdmin, accion, detalleLog);
    ...
    private void TablaPersonalAcademicoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaPersonalAcademicoMouseClicked
       try {
           ...
           ResultSet rs;
           Connection con=Conexion.obtenerConexion();
           ps= con.prepareStatement("SELECT RU, nombre, apellido, CI, telefono, email FROM personal_academico WHERE id_personal_academico=?");
           ps.setInt(1,id);
           rs=ps.executeQuery();
